...
/**
 * RETO: Detector de Anagramas.
 * 
 * Un anagrama es una palabra o frase formada reordenando las letras de otra.
 * Ejemplo: "Listen" y "Silent" son anagramas.
 * 
 * Tu tarea es implementar un método que reciba dos strings y devuelva 'true' 
 * si son anagramas, ignorando espacios y mayúsculas/minúsculas.
 */
