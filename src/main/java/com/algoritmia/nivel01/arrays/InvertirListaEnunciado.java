...
/**
 * 🎓 RETO: Invertir Lista Enlazada. <b>Dificultad: Fácil</b>
 *
 * <p>
 * Implementa un algoritmo para invertir una lista enlazada simple. La inversión
 * debe hacerse in-place, modificando los punteros `siguiente` de cada nodo.
 * </p>
 *
 ...
 * <li>En cada paso, guarda el siguiente nodo, invierte el puntero del nodo
 * actual hacia atrás, y avanza los punteros.</li>
...
public class InvertirListaEnunciado {
	 ...
	 * @return El nuevo nodo cabeza de la lista invertida, o null si la lista está
	 *         vacía.
	 */
