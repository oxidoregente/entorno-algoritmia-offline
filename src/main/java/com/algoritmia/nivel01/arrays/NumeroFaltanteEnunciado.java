...
/**
 * 🎓 RETO: Número Faltante.
 * <b>Dificultad: Fácil</b>
 *
 * <p>Dado un array `nums` que contiene `n` números distintos en el rango [0, n],
 * encuentra y devuelve el único número del rango que falta en el array.</p>
 *
 * <p>El array tiene exactamente `n` elementos, pero el rango [0, n] contiene `n+1` números,
 * por lo que siempre faltará exactamente un número.</p>
 *
 * <h3>Ejemplos:</h3>
 * <pre>
 * Entrada: nums = [3, 0, 1]
 ...
 *   <li>Calcula la suma esperada teórica y réstale la suma real de los elementos del array.</li>
