...
/**
 * 🎓 RETO: Máximo Subarreglo (Algoritmo de Kadane). <b>Dificultad: Media</b>
 *
 * <p>
 ...
 *
 * <p>
 * El objetivo es implementar el Algoritmo de Kadane, una técnica de
 * programación dinámica que resuelve este problema en tiempo lineal O(n).
 * </p>
 *
 * <h3>Ejemplo:</h3>
 * 
 ...
 * </p>
 * <ul>
 * <li>Recorre el array manteniendo dos variables: `sumaActual` y
 * `sumaMaxima`.</li>
...
public class MaximoSubarregloEnunciado {
	...
	/**
	 * Calcula la suma máxima de un subarreglo contiguo usando el Algoritmo de
	 * Kadane.
	 *
