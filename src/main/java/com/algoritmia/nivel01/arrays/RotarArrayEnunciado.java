 ...
 *
 * <p>Dado un array de enteros `nums`, implementa una función para rotar el array hacia la derecha
 * una cantidad de `k` pasos. La rotación debe ser in-place (modificando el array original directamente)
 * y con la mejor complejidad de tiempo y espacio posible.</p>
 *
 * <p>La cantidad de pasos `k` siempre será no negativa.</p>
 *
 * <h3>Ejemplo:</h3>
 * <pre>
 ...
 *   <li>Puedes usar un array auxiliar para una solución más sencilla, o intentar una solución
 *       más eficiente invirtiendo segmentos del array (como se sugiere en la teoría de la solución).</li>
 * </ul>
 */
