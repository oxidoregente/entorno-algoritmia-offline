...
/**
 * 🎓 RETO: Factorial Recursivo.
 * <b>Dificultad: Fácil</b>
 *
 * <p>El factorial de un número entero positivo `n` (n!) es el producto de todos
 * los números desde 1 hasta `n`. Por definición, 0! = 1.</p>
 *
 * <p>Ejemplo: 5! = 5 * 4 * 3 * 2 * 1 = 120.</p>
 *
 * <p>Tu tarea es implementar el cálculo del factorial usando exclusivamente RECURSIÓN.</p>
 *
 * <h3>Ejemplos:</h3>
 * <pre>
 * n = 0  -> 1
 ...
 *   <li>Se usa `long` para el resultado ya que el factorial crece rápidamente.</li>
 * </ul>
 */
