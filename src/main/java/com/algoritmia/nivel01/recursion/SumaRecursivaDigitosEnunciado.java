...
/**
 * 🎓 RETO: Suma Recursiva de Dígitos.
 * <b>Dificultad: Fácil</b>
 *
 * <p>Dado un número entero no negativo `n`, calcula la suma de todos sus dígitos
 * usando exclusivamente RECURSIÓN (sin bucles).</p>
 *
 * <h3>Ejemplos:</h3>
 * <pre>
 * n = 123 -> 6 (1 + 2 + 3)
 ...
 *   <li>Usa `n % 10` para obtener el último dígito y `n / 10` para eliminar el último dígito.</li>
