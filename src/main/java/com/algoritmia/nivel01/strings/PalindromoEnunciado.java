 ...
 *
 * <p>Un palíndromo es una palabra o frase que se lee igual de adelante hacia atrás.
 * Ejemplos: "Anita lava la tina", "Ojo", "Radar".</p>
 *
 * <p>Tu tarea es implementar un método que devuelva `true` si el string es un palíndromo,
 * ignorando mayúsculas, espacios y signos de puntuación. Solo debes considerar
...
public class PalindromoEnunciado {
    ...
    /**
     * Verifica si un string es un palíndromo, ignorando mayúsculas, espacios y puntuación.
     *
