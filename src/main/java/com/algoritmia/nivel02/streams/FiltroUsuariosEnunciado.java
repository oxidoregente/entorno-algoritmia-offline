 ...
 *
 * <p>Recibes una lista de objetos `Usuario`. Debes:</p>
 * <ol>
 ...
 * <p><b>Pistas:</b></p>
 * <ul>
 *   <li>Usa `filter(u -> u.edad() > 18)`, `sorted(Comparator.comparing(Usuario::nombre))`, y `map(Usuario::email)`.</li>
 * </ul>
 */
public class FiltroUsuariosEnunciado {
    ...
    /**
     * Obtiene los emails de los usuarios mayores de edad, ordenados alfabéticamente por nombre.
     *
