...
/**
 * 🎓 RETO: Calculadora de Recetas. <b>Dificultad: Media</b>
 *
 * <p>
 * Escala una receta filtrando ingredientes irrelevantes:
 * </p>
 * <ol>
 * <li>Filtra los ingredientes con cantidad menor a 10 gramos (son irrelevantes
 * para la escala).</li>
 * <li>Multiplica las cantidades de los ingredientes restantes por el
 * `multiplicador`.</li>
 * <li>Devuelve un Mapa donde la clave es el nombre del ingrediente y el valor
 * la nueva cantidad escalada.</li>
 * </ol>
 *
 * <h3>Ejemplo:</h3>
 * 
...
public class CalculadoraRecetasEnunciado {
	 ...
	 * @return Mapa con nombre del ingrediente y cantidad escalada (ingredientes >=
	 *         10g).
	 */
	public Map<String, Double> ajustarReceta(List<Ingrediente> ingredientes, double multiplicador) {
		...
		Map<String, Double> mapa = ingredientes.stream()
				.filter(e -> e.cantidadGramos > 10)
				.collect(Collectors.toMap(Ingrediente::nombre, e -> e.cantidadGramos * multiplicador));
