...
/**
 * 🎓 RETO: Filtrar Números Primos. <b>Dificultad: Media</b>
 *
 * <p>
 * Dada una lista de números enteros, filtra solo aquellos que son números
 * primos y devuelve una nueva lista con los resultados.
 * </p>
 *
 * <p>
 * Un número primo es aquel mayor que 1 que solo es divisible por sí mismo y por
 * 1.
 * </p>
 *
 * <h3>Ejemplo:</h3>
 ...
 * <li>Para verificar si es primo, itera desde 2 hasta la raíz cuadrada del
 * número.</li>
 * </ul>
 */
