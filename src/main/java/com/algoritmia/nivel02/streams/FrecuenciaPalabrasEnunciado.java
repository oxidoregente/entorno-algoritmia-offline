 ...
 *
 * <p>Dada una lista de palabras, devuelve un Mapa donde la clave es la palabra
 * y el valor es la cantidad de veces que aparece en la lista.</p>
 *
 * <h3>Ejemplo:</h3>
 * <pre>
 ...
 * <p><b>Pistas:</b></p>
 * <ul>
 *   <li>Usa `Collectors.groupingBy(Function.identity(), Collectors.counting())`.</li>
