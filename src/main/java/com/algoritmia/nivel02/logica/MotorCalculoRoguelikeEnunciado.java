 ...
 *
 * <p>Calcula el daño final infligido en un combate de un juego estilo Roguelike.</p>
 *
 * <p><b>Fórmula de cálculo:</b></p>
 * <ol>
 *   <li>Aplica el multiplicador del item al daño base: dañoBase * multiplicadorItem.</li>
 *   <li>Decide si el golpe es crítico usando `random.nextDouble()` y la probabilidad crítica.</li>
