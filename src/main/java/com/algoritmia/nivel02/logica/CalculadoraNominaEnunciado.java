 ...
 *
 * <p>Calcula el salario neto de un empleado considerando horas extra y deducciones.</p>
 *
 * <p><b>Fórmula:</b></p>
 * <pre>
 ...
 * </pre>
 *
 * <p><b>Regla de Negocio:</b> Si el salario neto resultante es menor al 50% del salario base,
 * debe lanzar una `RuntimeException` con el mensaje "Deducciones Excesivas".</p>
 *
 * <h3>Ejemplo:</h3>
 * <pre>
