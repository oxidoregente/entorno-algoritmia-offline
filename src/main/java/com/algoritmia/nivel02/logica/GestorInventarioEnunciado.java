...
/**
 * 🎓 RETO: Gestor de Inventario Crítico. <b>Dificultad: Fácil</b>
 *
 * <p>
 * Determina si una orden de compra puede ser procesada según las reglas de
 * inventario.
 * </p>
 *
 * <p>
 ...
 * </p>
 * <ol>
 * <li>Si la cantidad pedida es mayor que el stock disponible, devuelve
 * `RECHAZADO_SIN_STOCK`.</li>
 * <li>Si el producto es "VITAL" y después de procesar la orden el stock
 * restante es menor a 5, devuelve `ALERTA_STOCK_BAJO`.</li>
...
public class GestorInventarioEnunciado {
    ...
    public enum EstatusOrden {
        PROCESADO_EXITOSO, RECHAZADO_SIN_STOCK, ALERTA_STOCK_BAJO
    }

    /**
     * Procesa una orden de compra y devuelve su estatus según las reglas de
     * inventario.
     *
