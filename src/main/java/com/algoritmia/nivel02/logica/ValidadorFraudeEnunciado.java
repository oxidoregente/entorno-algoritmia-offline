...
/**
 * 🎓 RETO: Validador de Fraude Bancario. <b>Dificultad: Fácil</b>
 *
 * <p>
 * Determina si una transacción bancaria debe marcarse como SOSPECHOSA.
 * </p>
 *
 * <p>
 * Una transacción se considera sospechosa si cumple al menos una de las
 * siguientes reglas:
 * </p>
 * <ol>
 * <li>El monto de la transacción es mayor a $5000.</li>
 * <li>La hora de la transacción está entre las 00:00 y las 05:00
 * (madrugada).</li>
 * </ol>
 *
 * <h3>Ejemplo:</h3>
...
public class ValidadorFraudeEnunciado {
    ...
    public boolean esSospechosa(Transaccion t) {
        ...
        if (t.hora.isAfter(LocalTime.of(5, 0)) || t.hora.isBefore(LocalTime.of(0, 0)))
            return true;
