 ...
 * 
 * <p>
 * Teoría: El uso de la API de Streams para procesar colecciones (como la lista
 * de deducciones) permite escribir código más limpio y menos propenso a errores
 * de índice que un bucle 'for' tradicional.
 * </p>
 */
public class CalculadoraNominaSolucion {
    ...
    public double calcularNeto(double base, double valorHoraExtra, int cantidadHorasExtra,
        ...
        double totalDeducciones = (deducciones == null) ? 0 : deducciones.stream().mapToDouble(Deduccion::monto).sum();
