...
/**
 * 🎓 RETO: Servicio de Checkout Completo. <b>Dificultad: Difícil</b>
 *
 * <p>
 * Orquesta el flujo completo de checkout: validación de inventario, cálculo de
 * envío internacional, procesamiento de pago y notificación de evento. Integra
 * 3 dependencias inyectadas (inventario, envíos, procesador de pagos) más un
 ...
 * </p>
 * <ol>
 * <li>Validar inventario con
 * {@code GestorInventarioEnunciado.procesarOrden(...)}.</li>
 * <li>Calcular costo de envío con
 * {@code CalculadoraEnviosInternacionalesEnunciado.calcularCosto(...)}.</li>
 * <li>Calcular comisión de pago con
 * {@code ProcesadorPagosFintechEnunciado.calcularComision(...)}.</li>
 ...
 * 
 * <pre>
 * servicio.checkoutCompleto(50, // stockActual
 *         2, // cantidad
 *         true, // esVital
 *         "EUROPA", // zona
 *         2.5, // pesoKg
 ...
 * <li>Si el inventario no es PROCESADO_EXITOSO, retorna resumen con estado
 * "RECHAZADO".</li>
 * <li>El evento se publica siempre con el resumen final.</li>
 * <li>El método real de envíos es {@code calcularCosto(peso, zona)} (parámetros
 * invertidos).</li>
 * </ul>
 */
@Service
public class CheckoutCompletoEnunciado {
    ...
    public CheckoutCompletoEnunciado(GestorInventarioEnunciado inventario,
            CalculadoraEnviosInternacionalesEnunciado envios, ProcesadorPagosFintechEnunciado pagos,
     ...
     */
    public Map<String, Object> checkoutCompleto(int stockActual, int cantidad, boolean esVital, String zona,
            double pesoKg, double monto, TipoTarjeta tipoTarjeta) {
        // TODO: Implementa la orquestación completa

        var resumen = new HashMap<String, Object>();

        EstatusOrden estadoOrden = inventario.procesarOrden(stockActual, cantidad, esVital);
        resumen.put("estado", estadoOrden.name());

        if (estadoOrden == estadoOrden.RECHAZADO_SIN_STOCK) {
            ...
            String mensaje = String.format("Checkout OK - Envío: $%.2f, Comisión: $%.2f", costoEnvio, comision);
