...
/**
 * 🎓 RETO: Orquestador de Pedidos. <b>Dificultad: Difícil</b>
 *
 * <p>
 * Coordina el flujo completo de un proceso de venta. El pedido debe pasar por 3
 * fases secuenciales para ser considerado exitoso:
 * </p>
 *
 * <p>
 * <b>Flujo:</b>
 * </p>
 * <ol>
 * <li><b>Validar Stock:</b> Usa
 * {@code GestorInventarioEnunciado.procesarOrden(...)}. Si el estatus no es
 * {@code PROCESADO_EXITOSO}, la orden completa se rechaza.</li>
 * <li><b>Procesar Pago:</b> Usa
 * {@code ProcesadorPagosFintechEnunciado.calcularComision(...)}. Si el cálculo
 * falla, se revierte la orden de inventario.</li>
 * <li><b>Notificar:</b> Si todo es exitoso, publica un evento de dominio usando
 * {@link ApplicationEventPublisher}.</li>
 * </ol>
 *
 * <p>
 * <b>Enfoque de Testing:</b> Este reto se enfoca en orquestar múltiples
 * dependencias usando Mocks y verificar que todas fueron llamadas en el orden
 * correcto.
 * </p>
 *
 * <p>
 * <b>Nota arquitectónica:</b> Se usa {@code ApplicationEventPublisher}
 * (interfaz nativa de Spring) en lugar de importar una clase concreta de
 * mensajería. Esto desacopla este servicio del sistema de RabbitMQ, que se
 * introduce en el nivel 14.
 * </p>
 */
@Service
public class OrquestadorPedidosEnunciado {
    ...
    public OrquestadorPedidosEnunciado(GestorInventarioEnunciado inventario, ProcesadorPagosFintechEnunciado pagos,
    ...
    public boolean procesarPedido(String item, int cantidad, double monto, TipoTarjeta tipoTarjeta) {
        ...
        EstatusOrden estado = inventario.procesarOrden(100, cantidad, false);
