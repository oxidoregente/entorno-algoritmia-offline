 ...
 *
 * <p>Determina la fortaleza de una contraseña basándose en el cumplimiento de
 * múltiples reglas de seguridad:</p>
 * <ol>
 *   <li><b>Longitud:</b> Mínimo 8 caracteres.</li>
 *   <li><b>Números:</b> Debe contener al menos un dígito (0-9).</li>
 *   <li><b>Caracteres especiales:</b> Debe contener al menos uno de: !, @, #, $, %.</li>
 * </ol>
 *
 * <h3>Ejemplos:</h3>
 * <pre>
 ...
 * <p><b>Pistas:</b></p>
 * <ul>
 *   <li>Usa expresiones regulares o métodos helper para verificar cada regla.</li>
 *   <li>Cuenta cuántas reglas cumple la contraseña y asigna el nivel correspondiente.</li>
 * </ul>
 */
@Service
