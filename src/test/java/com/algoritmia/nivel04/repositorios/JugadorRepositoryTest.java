...
/**
 * Test para ejercicio de Repositorio de Jugador.
 * Valida consultas por estadísticas y nivel.
 */
@DataJpaTest
class JugadorRepositoryTest {
    ...
    void testTopJugadores() {
        repository.save(new JugadorEnunciado("UsuarioPrueba", 100));
        ...
        // Act
        // TODO: implementar findTop3ByOrderByPuntajeDesc en el repositorio
